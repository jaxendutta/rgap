...
BEGIN
    SET @query = CONCAT('
        ...
        IF(p_recipient_term IS NOT NULL, 
           CONCAT(' AND r.legal_name LIKE ''%', p_recipient_term, '%'' COLLATE utf8mb4_unicode_ci'), ''),
        IF(p_institute_term IS NOT NULL,
           CONCAT(' AND i.name LIKE ''%', p_institute_term, '%'' COLLATE utf8mb4_unicode_ci'), ''),
        IF(p_grant_term IS NOT NULL,
           CONCAT(' AND rg.agreement_title_en LIKE ''%', p_grant_term, '%'' COLLATE utf8mb4_unicode_ci'), ''),
