...
const Footer = () => {
    ...
    return (
        <footer className="hidden shrink-0 border-t border-gray-200 bg-slate-100/95 px-4 py-2 md:py-4 text-xs md:text-sm text-gray-500 backdrop-blur-sm lg:block">
            <div className="mx-auto flex max-w-7xl flex-nowrap items-center justify-center gap-2 text-center leading-none whitespace-nowrap">
                <span className="whitespace-nowrap">© {currentYear} {SITE_NAME}</span>
                <Link
                    href="/docs/privacy"
